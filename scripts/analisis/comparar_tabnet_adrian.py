...
df_datasus = pd.read_csv("outputs/dengue/dengue_datasus_vs_adrian.csv")
...
summary.to_csv('outputs/dengue/tabnet_casos_provaveis_2014_2016.csv', index=False, encoding='utf-8')

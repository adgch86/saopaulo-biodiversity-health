...
df_corr.to_csv(f"{PROJECT_ROOT}/outputs/correlaciones_completas_v4.csv", index=False)
...
df_mejores.to_csv(f"{PROJECT_ROOT}/outputs/mejores_predictores_v4.csv", index=False)
...
df_mixtos.to_csv(f"{PROJECT_ROOT}/outputs/modelos_mixtos_v4.csv", index=False)
...
print("  - outputs/correlaciones_completas_v4.csv")
print("  - outputs/mejores_predictores_v4.csv")
print("  - outputs/modelos_mixtos_v4.csv")
